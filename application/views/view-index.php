  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="./assets/adminlte/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Moch. Arfian (ATS)</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Dashboard [Moch Arfian Ardiansyah]</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3 id="umkmproject"></h3>

                <p>JUMLAH UMKM HANDLE PROJECT</p>
              </div>
              <div class="icon">
        ...
        <div class="row" style="padding-bottom: 20px;">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  ...
                  <div class="chart tab-pane active" id="revenue-chart"
                      ...
                      <canvas id="area-tren_nilai"></canvas>                         
                   </div>
                  <div class="chart tab-pane" id="sales-chart">
                    <canvas id="pie-budgets" ></canvas>                         
                  </div>  
                </div>
              </div><!-- /.card-body -->
            </div>
          ...
          <section class="col-lg-3 connectedSortable" id="pieie">
            ...
            <div class="card card-outline card-success" style="height:100%">
              ...
              <div class="card-body">
                <div id="world-map">
                  <canvas id="pie-budget"  width="500%"></canvas>
                </div>
              </div>
              <!-- /.card-body-->
          ...
          <section class="col-lg-3 connectedSortable">
            ...
            <!-- Map card -->
            <div class="card card-outline card-warning" style="height:100%">
              <div class="card-header border-0">
                <h3 class="card-title">
                  <i class="fas fa-map-marker-alt mr-1"></i>
                  Top 10 Seller
              ...
              <div class="card-body">
                <div id="world-map">
                  <canvas id="line-seller"  width="500%"></canvas>
                </div>
              </div>
              <!-- /.card-body-->
              <div class="card-footer bg-transparent">
            ...
            <div class="card card-outline card-primary">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  ...
                  <div id="peta" style="height: 100vh"></div>
